...
%%% @doc
%%% Output bias neuron supervisor who dynamically spawns bias neurons.
%%% @end
%%% Created : 02 July 2013 by cantheman <java10cana@gmail.com>
%%%-------------------------------------------------------------------
-module(e_ann_input_bias_neuron_sup).
...
init([]) ->
    log4erl:info("Starting input_bias_neuron supervisor with pid:(~p)~n",
                 [self()]),
